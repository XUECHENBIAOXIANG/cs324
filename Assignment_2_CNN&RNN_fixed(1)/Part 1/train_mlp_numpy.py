...
def train(dnn_hidden_units, learning_rate, max_steps, eval_freq, X_train, X_test, y_train, y_test, batch=True,
          batch_size=1):
    """
    ...
    return accuracy_list, accuracy_list_test, time, loss_list, loss_list_test
